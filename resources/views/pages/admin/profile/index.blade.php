                ...
                <div class="box">
                    ...
                    <div class="box-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="alamat" class="form-control" rows="5" required="required" readonly="readonly">{{ $panitia->alamat }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">No. Handphone</label>
                            <div class="col-sm-4">
                                <input type="number" class="form-control text-capitalize" name="no_hp" required="required" value="{{ $panitia->no_hp }}" readonly="readonly">
                            </div>
                        </div>
                    </div>
